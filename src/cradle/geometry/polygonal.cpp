...
polyset
scale(polyset const& set, cradle::vector<2, double> const& factor)
{
    point_scaling_fn fn;
    fn.factor = factor;
...
void
to_boost_polygon(boost_polygon_set& boost_set, polyset const& cradle_set)
{
...
void
from_boost_polygon(polyset& cradle_set, boost_polygon_set const& boost_set)
{
    cradle_set = polyset();

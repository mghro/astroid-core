...
bool static inline has_monitor(api_function_interface const& f)
{
...
bool static inline is_trivial(api_function_interface const& f)
{
...
bool static inline is_remote(api_function_interface const& f)
{
...
bool static inline is_disk_cached(api_function_interface const& f)
{
...
bool static inline is_upgrade(api_function_implementation_info const& f)
{
...
bool static inline is_reported(api_function_interface const& f)
{
...
// When merging api_implementations list the app containing previous_version
// second
api_implementation

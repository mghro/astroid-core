...
#define CRADLE_CHECK_ALMOST_EQUAL(expr1, expr2)                               \
    {                                                                         \
        ...
        {                                                                     \
            FAIL(                                                             \
                "CRADLE_CHECK_ALMOST_EQUAL() failed"                          \
                "\n    " #expr1 " != " #expr2 "\n    "                        \
                << expr1 << " != " << expr2);                                 \
        }                                                                     \
    }
...
#define CRADLE_CHECK_WITHIN_TOLERANCE(expr1, expr2, tolerance)                \
    {                                                                         \
        ...
        {                                                                     \
            FAIL(                                                             \
                "CRADLE_CHECK_WITHIN_TOLERANCE() failed"                      \
                "\n    " #expr1 " != " #expr2 "\n    "                        \
                << expr1 << " != " << expr2                                   \
                << "\n    tolerance: " << tolerance);                         \
        }                                                                     \
...
#define CRADLE_CHECK_RANGES_EQUAL_(begin1, end1, begin2, end2)                \
    {                                                                         \
        ...
        {                                                                     \
            FAIL(                                                             \
                "CRADLE_CHECK_RANGES_EQUAL() failed"                          \
...
#define CRADLE_CHECK_RANGES_ALMOST_EQUAL_(begin1, end1, begin2, end2)         \
    {                                                                         \
        ...
        {                                                                     \
            FAIL(                                                             \
                "CRADLE_CHECK_RANGES_ALMOST_EQUAL() failed"                   \
                "\n    (" #begin1 ", " #end1 ") != (" #begin2 ", " #end2      \
                ")"                                                           \
                "\n    sizes: "                                               \
                << std::distance(begin1, end1)                                \
        ...
        {                                                                     \
            std::string msg;                                                  \
            if (!cradle::impl::check_ranges_almost_equal(                     \
...
#define CRADLE_CHECK_RANGES_ALMOST_EQUAL(range1, range2)                      \
    CRADLE_CHECK_RANGES_ALMOST_EQUAL_(                                        \
        range1.begin(), range1.end(), range2.begin(), range2.end())

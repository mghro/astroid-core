#ifndef ASTROID_ENCODING_HPP
#define ASTROID_ENCODING_HPP
...
string
base36_encode(uint64_t id, unsigned minimum_length = 1);
...
// minimum_length is the minimum number of digits in the output string.
string
nonsequential_base36_encode(uint64_t id, unsigned minimum_length = 1);

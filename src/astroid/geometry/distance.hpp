#ifndef ASTROID_GEOMETRY_DISTANCE_HPP
#define ASTROID_GEOMETRY_DISTANCE_HPP
...
T
distance(
    line_segment<2, T> const& segment,
    vector<2, T> const& p,
    vector<2, T>* closest_point);
template<typename T>
T
distance(line_segment<2, T> const& segment, vector<2, T> const& p)
{
...
template<typename T>
T
distance2(line_segment<2, T> const& segment, vector<2, T> const& p)
{
...
distance(polygon2 const& poly, vector<2, double> const& p)
{
...
distance2(
    ...
    vector<2, double>* closest_point);
static inline double
distance2(polygon2 const& poly, vector<2, double> const& p)
{
...
absolute_distance2(
    ...
    vector<2, double>* closest_point);
static inline double
absolute_distance2(polygon2 const& poly, vector<2, double> const& p)
{
...
distance(
    ...
    vector<2, double>* closest_point);
static inline double
distance(polyset const& area, vector<2, double> const& p)
{
...
distance2(
    ...
    vector<2, double>* closest_point);
static inline double
distance2(polyset const& area, vector<2, double> const& p)
{
...
absolute_distance2(
    ...
    vector<2, double>* closest_point);
static inline double
absolute_distance2(polyset const& area, vector<2, double> const& p)
{
...
#include <astroid/geometry/distance.ipp>

#ifndef ASTROID_IMAGING_VIEW_TRANSFORMS_HPP
#define ASTROID_IMAGING_VIEW_TRANSFORMS_HPP
...
template<unsigned N, class T, class SP>
image<N, T, SP>
flipped_view(image<N, T, SP> const& img, unsigned axis)
{
...
template<unsigned N, class T, class SP>
void
invert_axis(image<N, T, SP>& img, unsigned axis)
{
...
void
invert_axis(image<N, variant, SP>& img, unsigned axis);
...
template<unsigned N, class T, class SP>
image<N, T, SP>
aligned_view(image<N, T, SP> const& img)
{
...
template<unsigned N, class SP>
image<N, variant, SP>
aligned_view(image<N, variant, SP> const& img);
...
template<unsigned N, class T, class SP>
image<N, T, SP>
raw_flipped_view(image<N, T, SP> const& img, unsigned axis)
{
    image<N, T, SP> r = img;
...
template<unsigned N, class SP>
image<N, variant, SP>
raw_flipped_view(image<N, variant, SP> const& img, unsigned axis);
...
image<2, T, SP>
raw_rotated_180_view(image<2, T, SP> const& img)
{
    image<2, T, SP> r = img;
...
template<class SP>
void
raw_rotated_180_view(image<2, variant, SP>& img);

template<class T, class SP>
image<2, T, SP>
raw_rotated_90ccw_view(image<2, T, SP> const& img)
{
    image<2, T, SP> r = img;
...
template<class SP>
void
raw_rotated_90ccw_view(image<2, variant, SP>& img);

template<class T, class SP>
image<2, T, SP>
raw_rotated_90cw_view(image<2, T, SP> const& img)
{
    image<2, T, SP> r = img;
...
template<class SP>
void
raw_rotated_90cw_view(image<2, variant, SP>& img);

// subimage_view() returns a view of a subregion of an image.
template<unsigned N, class T, class SP>
image<N, T, SP>
subimage_view(image<N, T, SP> const& img, box<N, unsigned> const& region)
{
    image<N, T, SP> r = img;
    for (unsigned i = 0; i < N; ++i)
...
image<N, variant, SP>
subimage_view(
    image<N, variant, SP> const& img, box<N, unsigned> const& region);
...
template<unsigned N, class T, class SP>
image<N, T, SP>
subsampled_view(image<N, T, SP> const& img, vector<N, unsigned> const& step)
{
    image<N, T, SP> r = img;
    for (unsigned i = 0; i < N; ++i)
    {
...
image<N, variant, SP>
subsampled_view(
    image<N, variant, SP> const& img, vector<N, unsigned> const& step);

} // namespace astroid

#include <astroid/imaging/view_transforms.ipp>

    ...
    image<N, Pixel2, Storage2> const& img2)
{
    ...
    optional<box<N, double>> common_box = intersection(box1, box2);
    if (!common_box)
        return false;
    ...
    create_grid_for_box(grid, *common_box, spacing);
    return true;
}
    ...
    Op& op)
{
    ...
    typename regular_grid_point_list<N, double>::const_iterator point_i
        = points.begin();
    ...
    Op& op)
{
    ...
    typename regular_grid_point_list<N, double>::const_iterator point_i
        = points.begin();
    typename regular_grid_point_list<N, double>::const_iterator point_end
        = points.end();

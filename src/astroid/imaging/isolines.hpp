#ifndef ASTROID_IMAGING_ISOLINES_HPP
#define ASTROID_IMAGING_ISOLINES_HPP
...
compute_isolines(
    ...
    // The level that will determine where the isolines will be placed on the
    // image.
    double level);

#ifndef ASTROID_IMAGING_STATISTICS_HPP
#define ASTROID_IMAGING_STATISTICS_HPP
...
api(fun with(N : 1, 2, 3; T : variant; SP : shared))
template<unsigned N, class T, class SP>
// The statistics (minimum, maximum, mean, and number of values) of the given
// image.
statistics<double>
image_statistics(
...
api(fun with(N : 1, 2, 3; T : variant; SP : shared))
template<unsigned N, class T, class SP>
// The statistics (minimum, maximum, mean, and number of values) over a subset
// of the given image.
statistics<double>
...
api(fun with(N : 1, 2, 3; T : variant; SP : shared))
template<unsigned N, class T, class SP>
// The statistics (minimum, maximum, mean, and number of values) over a
// weighted subset of the given image.
statistics<double>
weighted_partial_image_statistics(
    // The image from which the statistics will be calculated.
    image<N, T, SP> const& img,
    // The subset of image indices and their weights from which the satistics
    // will be calculated.

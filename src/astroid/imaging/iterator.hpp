#ifndef ASTROID_IMAGING_ITERATOR_HPP
#define ASTROID_IMAGING_ITERATOR_HPP
          ...
          boost::forward_traversal_tag>
{
 ...
 public:
    image_iterator() : img_(0), pixel_(0)
    {
    }
 ...
 private:
    ...
    bool
    equal(image_iterator const& other) const
    {
    ...
    typename image<N, Pixel, Storage>::reference_type
    dereference() const
    {
        return *pixel_;
    }
...
template<unsigned N, class Pixel, class Storage>
image_iterator<N, Pixel, Storage>
get_begin(image<N, Pixel, Storage> const& img)
{
...
template<unsigned N, class Pixel, class Storage>
image_iterator<N, Pixel, Storage>
get_end(image<N, Pixel, Storage> const& img)
{
          ...
          boost::forward_traversal_tag>
{
 ...
 private:
    ...
    bool
    equal(span_iterator const& other) const
    {
        return this->pixel_ == other.pixel_;
    }
...
span_iterator<2, Pixel, Storage>
get_row_begin(image<2, Pixel, Storage> const& img, unsigned y)
{
...
template<class Pixel, class Storage>
span_iterator<2, Pixel, Storage>
get_row_end(image<2, Pixel, Storage> const& img, int y)
{
    return span_iterator<2, Pixel, Storage>(
        img,
        0,
        get_iterator(img.pixels) + y * img.step[1]

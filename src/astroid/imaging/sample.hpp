#ifndef ASTROID_IMAGING_SAMPLE_HPP
#define ASTROID_IMAGING_SAMPLE_HPP
...
template<unsigned N, class T, class SP>
// The sample value of the image at the specified point. If the point lies
// outside the image, and empty value is returned.
...
api(fun trivial with(N : 1, 2, 3; T : variant; SP : shared))
template<unsigned N, class T, class SP>
// The interpolated sample value of the image at the specified point. If the
// point lies outside the image, and empty value is returned.
optional<typename replace_channel_type<T, double>::type>
...
api(fun trivial with(N : 1, 2, 3; T : variant; SP : shared))
template<unsigned N, class T, class SP>
// The average sample value of the image over the specified box. If the box
// lies outside the image, and empty value is returned.
optional<typename replace_channel_type<T, double>::type>
...
#include <astroid/imaging/sample.ipp>

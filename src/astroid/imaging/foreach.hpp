#ifndef ASTROID_IMAGING_FOREACH_HPP
#define ASTROID_IMAGING_FOREACH_HPP
...
template<unsigned N, class Pixel, class Storage, class Functor>
void
foreach_pixel(image<N, Pixel, Storage> const& img, Functor& fn)
{
    ...
    Functor& fn)
{
    ...
    foreach_pixel2_algorithm<N - 1>::apply(
        img1, get_iterator(img1.pixels), img2, get_iterator(img2.pixels), fn);
}
    ...
    Functor& fn)
{
    ...
    foreach_pixel3_algorithm<N - 1>::apply(
        img1,
        get_iterator(img1.pixels),
        img2,
        get_iterator(img2.pixels),
        img3,
        get_iterator(img3.pixels),
        fn);
}

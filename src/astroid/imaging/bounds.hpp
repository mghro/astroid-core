#ifndef ASTROID_IMAGING_BOUNDS_HPP
#define ASTROID_IMAGING_BOUNDS_HPP
...
memory_bounds<Pixel>
get_quick_bounds(image<N, Pixel, Storage> const& img)
{
...
template<class Pixel>
bool
within_bounds(memory_bounds<Pixel> const& bounds, Pixel const* ptr)
{
